...
{
    public class CreateBattleValidator : AbstractValidator<CreateBattleRequest>
    {
        public CreateBattleValidator()
        {
            ...
            RuleFor(x => x.AmountDefenderSoldiers).NotNull().NotEmpty().GreaterThanOrEqualTo(1).WithMessage("Debe ser mayor a 1 la defensa de los soldados");
            RuleFor(x => x.AmountAttackerSoldiers).NotEmpty().NotNull().GreaterThanOrEqualTo(1).WithMessage("Ingresa un valor valido para el ataque de soldados");
